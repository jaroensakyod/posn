...
export const practiceQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: ['K', 'Ca', 'Na', 'Cu'],
    correctIndex: 2,
    explanation: 'Na ให้เปลวสีเหลืองเข้ม, K ม่วง, Ca แดงอิฐ/ส้ม, Cu เขียว',
    difficulty: 'easy',
  },
  ...
  // --- Representative Elements (สมบัติของธาตุหมู่หลัก) ---
  {
    ...
    choices: ['Li', 'Na', 'K', 'Cs'],
    correctIndex: 3,
    explanation: 'ความว่องไวต่อน้ำเพิ่มขึ้นตามหมู่ (Li < Na < K < Cs) เพราะ IE₁ ลดลง อิเล็กตรอนถูกปลดปล่อยได้ง่ายขึ้น',
    difficulty: 'easy',
  },
  {
    id: 're-2',
    ...
    correctIndex: 2,
    explanation: 'Al₂O₃ ทำปฏิกิริยากับ HCl → AlCl₃ และกับ NaOH → NaAlO₂ | Na₂O, CaO = basic | SO₃ = acidic',
    difficulty: 'medium',
  },
  {
    id: 're-3',
    ...
    correctIndex: 2,
    explanation: 'ความสามารถ oxidize: F₂ > Cl₂ > Br₂ > I₂ | Cl₂ + 2KBr → 2KCl + Br₂ ✓ | I₂ ไม่แทน Cl⁻ ได้',
    difficulty: 'medium',
  },
  {
    id: 're-4',
    ...
    correctIndex: 2,
    explanation: 'A = Mg (+2), B = Cl (−1) → MgCl₂ = AB₂',
    difficulty: 'easy',
  },
  {
    id: 're-5',
    ...
    choices: [
      ...
      'BeO เป็น amphoteric, MgO เป็น basic oxide',
      'ทั้งคู่เป็น acidic oxide',
      'MgO เป็น amphoteric, BeO เป็น basic oxide',
    ],
    correctIndex: 1,
    explanation: 'Be²⁺ มีขนาดเล็ก charge density สูง → BeO เป็น amphoteric | MgO เป็น basic oxide ล้วน',
    difficulty: 'hard',
  },
  ...
  // --- Nuclear Chemistry (เคมีนิวเคลียร์) ---
  {
    ...
    text: '²²⁶₈₈Ra สลายตัวโดยปล่อยรังสีแอลฟา ผลิตภัณฑ์ที่ได้คือธาตุใด',
    choices: ['²²²₈₆Rn', '²²²₈₈Ra', '²³⁰₉₀Th', '²²⁴₈₆Rn'],
    correctIndex: 0,
    explanation: 'สลาย α: A ลด 4, Z ลด 2 | ²²⁶₈₈Ra → ²²²₈₆Rn + ⁴₂He | Z=86 = Rn, A=222',
    difficulty: 'easy',
    hasMath: true,
  },
  {
    id: 'nc-2',
    topicId: 'nuclear-chemistry',
    text: 'ไอโซโทป X มีครึ่งชีวิต 10 วัน เริ่มต้น 160 g ผ่านไป 40 วัน เหลือกี่กรัม',
    choices: ['20 g', '10 g', '5 g', '40 g'],
    correctIndex: 1,
    explanation: 'n = 40/10 = 4 ครึ่งชีวิต | เหลือ = 160 × (½)⁴ = 160/16 = 10 g',
    difficulty: 'medium',
  },
  {
    id: 'nc-3',
    topicId: 'nuclear-chemistry',
    text: 'การสลายตัวชนิดใดทำให้เลขอะตอม (Z) เพิ่มขึ้น 1 หน่วย',
    choices: ['แอลฟา (α)', 'บีตา (β⁻)', 'แกมมา (γ)', 'โพซิตรอน (β⁺)'],
    correctIndex: 1,
    explanation: 'β⁻ decay: นิวตรอน → โปรตอน + e⁻ | Z เพิ่ม 1, A คงที่ | α: Z ลด 2 | γ: ไม่เปลี่ยน | β⁺: Z ลด 1',
    difficulty: 'easy',
  },
  {
    id: 'nc-4',
    topicId: 'nuclear-chemistry',
    text: 'ปฏิกิริยานิวเคลียร์ใดเป็นปฏิกิริยาฟิวชัน (Fusion)',
    choices: ['²³⁵U + n → Kr + Ba + 3n', '²H + ³H → ⁴He + n', '²³⁸U → ²³⁴Th + α', '¹⁴C → ¹⁴N + β⁻'],
    correctIndex: 1,
    explanation: 'Fusion = นิวเคลียสเบารวมกัน | ²H + ³H → ⁴He + n ✓ | ข้อ ก = Fission | ข้อ ค, ง = Decay',
    difficulty: 'medium',
  },
  {
    id: 'nc-5',
    topicId: 'nuclear-chemistry',
    text: 'ซากไม้โบราณมี ¹⁴C เหลือ 12.5% (t½ = 5730 ปี) ซากนี้มีอายุเท่าใด',
    choices: ['5,730 ปี', '11,460 ปี', '17,190 ปี', '22,920 ปี'],
    correctIndex: 2,
    explanation: '12.5% = (½)³ → ผ่าน 3 ครึ่งชีวิต | อายุ = 3 × 5730 = 17,190 ปี',
    difficulty: 'medium',
  },
]
